...
// SWExtensions
#define COCOAPODS_POD_AVAILABLE_SWExtensions
#define COCOAPODS_VERSION_MAJOR_SWExtensions 0
#define COCOAPODS_VERSION_MINOR_SWExtensions 1
#define COCOAPODS_VERSION_PATCH_SWExtensions 0
